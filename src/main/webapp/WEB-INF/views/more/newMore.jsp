...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/custom/more/newMore.js"></script>
...
<script type="text/javascript">
	...
	<h2 class="stit"><img src="/img/design/latest_caller_ring.gif" alt="최신 통화연결음" /></h2>
	<!-- 검색 영역 -->
	...
	<!-- 곡 리스트 영역 -->
		<input type="hidden" id="listDiv-currentPage" name="listDiv-currentPage" value="1" />
		<div id="newSongDiv" class="tb_type">
